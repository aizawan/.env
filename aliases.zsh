...
alias dcrhg='docker run -it --rm --shm-size=32G --gpus all -u `id -u`:`id -g` -v /home/aizawa/workspace:/home/aizawa/workspace -v /home/aizawa/dataset:/home/aizawa/dataset -v /media:/media aizawa-pytorch.1.8.1-cuda11.1.1-ubuntu20.04:latest /bin/zsh' 
